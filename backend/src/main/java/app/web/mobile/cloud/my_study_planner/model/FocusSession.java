...
/**
 * Entity JPA che rappresenta una sessione di studio dell'utente.
 *
 * Contiene informazioni relative al soggetto studiato, durata, completamento,
 * giorno della sessione, eventuale associazione a una task e utente proprietario.
 *
 * La classe viene mappata nella tabella "focus_sessions" del database.
 */
...
public class FocusSession {
    ...
    // restituisce la data della sessione come stringa
    @JsonProperty("day")
    public String getDayAsString() {
        return sessionDay != null ? sessionDay.toString() : null;
    }

    // imposta la data della sessione a partire da una stringa
    @JsonProperty("day")
    ...
    // restituisce l'id della task associata come stringa
    @JsonProperty("taskId")
    public String getTaskIdAsString() {
        return taskId != null ? taskId.toString() : null;
    }

    // imposta l'id della task associata a partire da una stringa
    @JsonProperty("taskId")
