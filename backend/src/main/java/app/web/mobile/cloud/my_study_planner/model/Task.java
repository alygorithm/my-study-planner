...
/**
 * Entity JPA che rappresenta una task assegnata a un utente.
 *
 * Contiene informazioni sulla task come titolo, descrizione, materia,
 * priorità, stato, durata e date di creazione/aggiornamento.
 *
 * La classe viene mappata nella tabella "tasks" del database.
 */
